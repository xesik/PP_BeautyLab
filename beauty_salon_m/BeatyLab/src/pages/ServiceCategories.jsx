...
const ServiceCategories = ({ categories, onSelect, selected }) => {
  return (
    <section className="flex flex-col gap-5 w-full items-center">
      ...
      <div className="flex flex-wrap gap-5 justify-between px-4 py-3.5 max-w-full text-3xl font-light text-center bg-stone-300 bg-opacity-10 rounded-[30px] text-stone-700 w-[1154px]">
